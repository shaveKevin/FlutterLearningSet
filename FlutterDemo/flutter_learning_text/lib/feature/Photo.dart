...
class PhotoTestDemoPage extends StatefulWidget {
  // 调用super方法
  PhotoTestDemoPage({Key key, this.title}) : super(key: key);
  ...
  _PhotoTestDemoPageState createState() => _PhotoTestDemoPageState();
}

// .m 文件
class _PhotoTestDemoPageState extends State<PhotoTestDemoPage> {
  // 是否显示loading
